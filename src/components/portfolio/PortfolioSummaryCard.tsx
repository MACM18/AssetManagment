    ...
    return (
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700'>
        <div className='text-center py-8'>
          ...
          <p className='text-gray-600 dark:text-gray-300 font-medium'>No holdings yet</p>
          <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
        ...
        <div className='bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800'>
          <div className='flex items-center gap-2 mb-1'>
            ...
            <p className='text-xs font-medium text-blue-800 dark:text-blue-300 uppercase'>
              Invested
            </p>
          </div>
          ...
          <p className='text-xs text-blue-700 dark:text-blue-300 mt-1'>LKR</p>
        </div>
        ...
        <div className='bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800'>
          <div className='flex items-center gap-2 mb-1'>
            ...
            <p className='text-xs font-medium text-purple-800 dark:text-purple-300 uppercase'>
              Current Value
            </p>
          </div>
          ...
          <p className='text-xs text-purple-700 dark:text-purple-300 mt-1'>LKR</p>
        </div>
        ...
        >
          ...
          <p
            className={`text-xs mt-1 ${
              isGain 
                ? "text-green-700 dark:text-green-400 dark:text-green-300" 
                : "text-red-700 dark:text-red-400 dark:text-red-300"
            }`}
          >
            LKR
          </p>
