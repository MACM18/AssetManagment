      ...
      <div className='space-y-3'>
        {topHoldings.map((holding, index) => {
          ...
          return (
            <div
              key={holding.id}
              className='flex items-center gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-800 transition-colors'
            >
              {/* Rank */}
              ...
              <div className='flex-1 min-w-0'>
                <div className='flex items-center gap-2'>
                  <p className='font-bold text-gray-900 dark:text-gray-100'>{holding.symbol}</p>
                  <span
